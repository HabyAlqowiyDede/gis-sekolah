  ...
  */
  ...
  <style>
    ...
    .peta-panel::-webkit-scrollbar { width: 6px; }
    .peta-panel::-webkit-scrollbar-thumb { background: #d6dce5; border-radius: 6px; }
    ...
    .peta-panel .panel-card:nth-child(1) { animation-delay: .02s; }
    .peta-panel .panel-card:nth-child(2) { animation-delay: .07s; }
    .peta-panel .panel-card:nth-child(3) { animation-delay: .12s; }
    .peta-panel .panel-card:nth-child(4) { animation-delay: .17s; }
    ...
    .jenjang-btn[data-jenjang="TK"].active  { background: var(--pj-tk);  border-color: var(--pj-tk); }
    .jenjang-btn[data-jenjang="SD"].active  { background: var(--pj-sd);  border-color: var(--pj-sd); }
    .jenjang-btn[data-jenjang="SMP"].active { background: var(--pj-smp); border-color: var(--pj-smp); }
    .jenjang-btn[data-jenjang="SMA"].active { background: var(--pj-sma); border-color: var(--pj-sma); }
    .jenjang-btn[data-jenjang="SMK"].active { background: var(--pj-smk); border-color: var(--pj-smk); }
    ...
    .kecamatan-select:focus { border-color: var(--blue-primary, #2563eb); }
    ...
    .dot.tk  { background: var(--pj-tk); }
    .dot.sd  { background: var(--pj-sd); }
    .dot.smp { background: var(--pj-smp); }
    .dot.sma { background: var(--pj-sma); }
    .dot.smk { background: var(--pj-smk); }
    ...
    .map-layer-toggle:hover { border-color: var(--blue-primary, #2563eb); }

    .map-layer-toggle i:first-child { color: var(--blue-primary, #2563eb); }
    ...
    .map-layer-toggle.open .fa-chevron-down { transform: rotate(180deg); }
    ...
    .popup-sekolah .popup-body { padding: 13px 14px 14px; }
    ...
    .popup-sekolah .popup-row:last-child { margin-bottom: 0; }
    ...
    .search-results .results-header h6 { margin: 0; }
    ...
    .search-results .results-header a:hover { color: var(--pj-ink); }
    ...
    .results-empty i { font-size: 20px; color: #cbd5e1; }
    .results-empty span { font-size: 12.5px; }
    ...
    .peta-panel.collapsed .panel-toggle i { transform: rotate(180deg); }
    ...
    @media (max-width: 768px) {
      ...
      .peta-search { padding: 11px 13px; }
      .peta-search input { font-size: 15px; }
      ...
      .kecamatan-select { padding: 11px 30px 11px 13px; font-size: 14px; }

      .search-clear { width: 24px; height: 24px; font-size: 12px; }
      ...
      .map-layer-toggle { padding: 11px 14px; }
    }
  </style>
  ...
  <script>
    ...
    var jenjangColors = {
      'TK':  { color: '#16a34a', bg: '#ecfdf3', dot: 'tk' },
      'SD':  { color: '#e11d48', bg: '#fef1f3', dot: 'sd' },
      'SMP': { color: '#2563eb', bg: '#eff6ff', dot: 'smp' },
      'SMA': { color: '#d97706', bg: '#fffaeb', dot: 'sma' },
      'SMK': { color: '#7c3aed', bg: '#f5f3ff', dot: 'smk' }
    };

    function jenjangStyle(j) {
      return jenjangColors[j] || { color: '#64748b', bg: '#f1f5f9', dot: '' };
    }
