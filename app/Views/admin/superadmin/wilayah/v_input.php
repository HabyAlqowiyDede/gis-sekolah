...
<div class="col-md-12">
    <div class="wilayah-form-hero">
        <div>
            <h3>Tambah Wilayah Administrasi</h3>
            <p>Tambahkan wilayah baru dengan warna custom dan data GeoJSON.</p>
        </div>
    ...
    <div class="card wilayah-form-card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_wilayah" value="<?= esc(old('nama_wilayah')) ?>" placeholder="Contoh: Kabupaten Tanah Datar" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Warna Wilayah</label>
                        <input type="text" name="warna" value="<?= esc(old('warna')) ?>" placeholder="#FF5733" class="form-control my-colorpicker1" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="geojson" class="form-control" rows="12" placeholder="Paste GeoJSON data here..." required><?= esc(old('geojson')) ?></textarea>
            </div>
